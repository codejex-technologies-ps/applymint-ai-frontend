  ...
  const features = [
    {
      ...
      description: 'Our intelligent algorithm analyzes your resume and matches you with jobs that perfectly fit your skills, experience, and career goals.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Never lose track of your applications again. Our AI organizes and monitors all your job applications with smart insights.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Get notified instantly when dream jobs are posted. Our AI learns your preferences and sends only relevant opportunities.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Prepare for interviews with AI-generated questions, company insights, and personalized coaching tailored to each role.',
      benefits: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our comprehensive AI platform streamlines every step of your job search journey, 
            from finding the perfect match to acing the interview.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center space-x-4 bg-card border border-border rounded-2xl p-6 shadow-lg">
            ...
            <div className="text-left">
              <p className="font-semibold text-primary mb-1">Ready to supercharge your job search?</p>
              <p className="text-sm text-muted-foreground">Join thousands who found their dream jobs with ApplyMint AI</p>
            </div>
            <Button 
              asChild
